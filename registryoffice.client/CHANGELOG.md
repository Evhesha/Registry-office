...
- Create Angular project with ng: `ng new registryoffice.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`registryoffice.client.esproj`).
